...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function hideAllSections(){ Object.values(sections).forEach(s=>s.classList.add('hidden')); }

  btns.btnStany.addEventListener('click', ()=>{ hideAllSections(); sections.inventory.classList.remove('hidden'); });
  btns.btnRaporty.addEventListener('click', ()=>{ hideAllSections(); sections.reports.classList.remove('hidden'); });
  btns.btnDokumenty.addEventListener('click', ()=>{ hideAllSections(); sections.documents.classList.remove('hidden'); });
  btns.btnWydanie.addEventListener('click', ()=>{ hideAllSections(); sections.wydanieTowaru.classList.remove('hidden'); });
